...
SELECT CAST('2017/4//' AS timestamp with time zone);
...
COPY actors
FROM 'C:\practical-sql-main\Chapter_04\movies.txt'
...
TO 'C:\practical-sql-main\Chapter_04\us_counties_housing_export.txt'
